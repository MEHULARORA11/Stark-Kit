...
import { run, isHITLPause } from "../agent/run.js";
...
const agent = new Agent({
  ...
  provider,
  instructions:
    "you always reply in anger mode amd provide the accurate weather details by providing city names to the accurate tool ",
  tools: [weatherTool],
...
if (isHITLPause(response)) {
  console.log("Run paused — awaiting human approval:", response.pendingToolCalls);
} else {
